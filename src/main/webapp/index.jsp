...
<div class="auth-container">
    ...
    <div id="login-form" class="auth-form">
        ...
        <div class="auth-switch">
            <p>¿No tienes cuenta?
                <a href="#" class="switch-link" onclick="showRegistration()">Regístrate</a>
            </p>
        </div>

        <div class="auth-switch">
            <p>¿Solo quieres explorar?
                <a href="ingresoInvitado" class="btn-secondary">Ingresar sin registrar</a>
            </p>
        </div>
    </div>
    ...
    <div id="register-form" class="auth-form hidden">
        ...
        <form action="registro" method="post">
            ...
            <div class="form-group checkbox-group">
                <label>
                    <input type="checkbox" id="isLector" name="isLector" value="true">
        ...
        <div class="auth-switch">
            <p>¿Ya tienes cuenta?
                <a href="#" class="switch-link" onclick="showLogin()">Iniciar Sesión</a>
            </p>
        </div>
    </div>
