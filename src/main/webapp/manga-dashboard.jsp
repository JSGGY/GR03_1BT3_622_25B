...
<div class="dashboard-container">
    ...
    <div class="mangas-container">
        <!-- Header con título y botón de ordenar -->
        <div class="mangas-header">
            ...
            <% if (ordenadoPorLikes) { %>
            <!-- Botón para volver al orden normal -->
            <a href="manga?scanId=<%= scan.getId() %>"
               class="btn-ordenar">
            ...
            <a href="manga?scanId=<%= scan.getId() %>&ordenarPorLikes=true"
               class="btn-ordenar">
                <span class="icon">⭐</span>
            ...
            <%
                if (mangas != null && !mangas.isEmpty()) {
                    for (com.app.model.Manga manga : mangas) {
                        ...
                        int totalLikes = manga.getTotalLikes();
            %>
