...
<div class="dashboard-container">
    ...
    <div class="section-container">
        ...
        <div class="section-card">
            <h3>⭐ Favoritos</h3>
            <%
                java.util.List<com.app.model.Manga> favoritos = (java.util.List<com.app.model.Manga>) request.getAttribute("favoritos");
                if (favoritos != null && !favoritos.isEmpty()) {
            %>
            <div class="favoritos-lista">
                <% for (com.app.model.Manga manga : favoritos) {
                    String scanNombre = manga.getScan() != null ? manga.getScan().getNombre() : "Sin scan";
                    int scanId = manga.getScan() != null ? manga.getScan().getId() : 0;
                %>
                <div class="favorito-item">
                    <div class="favorito-info">
                        <h4><%= manga.getTitulo() %></h4>
                        <p><%= scanNombre %></p>
                    </div>
                    <div class="favorito-actions">
                        <a href="mangaDetalle?mangaId=<%= manga.getId() %>&scanId=<%= scanId %>" class="btn-primary btn-small">
                            Ver Detalles
                        </a>
