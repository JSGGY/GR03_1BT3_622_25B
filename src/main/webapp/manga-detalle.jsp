...
<div class="manga-detalle-container">
    <%
        ...
        Boolean usuarioYaDioLike = (Boolean) request.getAttribute("usuarioYaDioLike");
        Boolean esFavorito = (Boolean) request.getAttribute("esFavorito");

        if (totalLikes == null) totalLikes = 0;
        if (usuarioYaDioLike == null) usuarioYaDioLike = false;
        if (esFavorito == null) esFavorito = false;
    ...
    <div class="manga-header-section">
        ...
        <div class="manga-info">
            ...
            <div class="manga-meta">
                ...
                <div class="manga-meta-item likes-meta">
            ...
            <div class="manga-actions">
                ...
                <form action="mangaLike" method="post" style="display: inline;">
                    <input type="hidden" name="action" value="agregar">
                    <input type="hidden" name="mangaId" value="<%= manga.getId() %>">
                    <input type="hidden" name="scanId" value="<%= scan.getId() %>">
                    <input type="hidden" name="origen" value="detalle">
                    <button type="submit" class="btn-secondary" <%= usuarioYaDioLike ? "disabled" : "" %>>
